...
public class Assembler_PassOne_V2 {
	...
	static void pass1() throws Exception {
		BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("/home/student/Downloads/pass1 program/input.txt")));
		out_pass1 = new PrintWriter(new FileWriter("/home/student/Downloads/pass1 program/output_pass1.txt"), true);
		PrintWriter out_symtable = new PrintWriter(new FileWriter("/home/student/Downloads/pass1 program/symtable.txt"), true);
		PrintWriter out_littable = new PrintWriter(new FileWriter("/home/student/Downloads/pass1 program/littable.txt"), true);
		String s;
	...
	static void initializeTables() throws Exception {
		...
		String s,mnemonic;
		BufferedReader br;
		br = new BufferedReader(new InputStreamReader(new FileInputStream("/home/student/Downloads/pass1 program/mot.txt")));
