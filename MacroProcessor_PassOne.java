...
public class MacroProcessor_PassOne {
    ...
    static void pass1() throws Exception {
        ...
        mntPtr = 0;
        mdtPtr = 0;
 BufferedReader input = new BufferedReader(new InputStreamReader(new FileInputStream("/home/student/Downloads/ pass1/macropass1/input.txt")));
        PrintWriter out_pass1 = new PrintWriter(new FileWriter("/home/student/Downloads/macro pass1/macropass1/output_pass1.txt"), true);
        PrintWriter out_mnt = new PrintWriter(new FileWriter("/home/student/Downloads/macro pass1/macropass1/MNT.txt"), true);
        PrintWriter out_mdt = new PrintWriter(new FileWriter("/home/student/Downloads/macro pass1/macropass1/MDT.txt"), true);
        PrintWriter out_ala = new PrintWriter(new FileWriter("/home/student/Downloads/macro pass1/macropass1/ALA.txt"), true);
